...
#        tf.reset_default_graph()
        ...
        saver.save(sess,'./fruit2/orange.ckpt')
        output_graph_def = graph_util.convert_variables_to_constants(sess, graph_def, ["final_training_ops/final_ret"])
        with tf.gfile.FastGFile('/home/shinong/big_bumper/1213-20Kphoto/combined.pb', 'wb') as f:

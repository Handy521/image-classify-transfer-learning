...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  13 15:37:14 2018
...
#INPUT_DATA = '/home/shinong/big_bumper/tensorflow-vgg/flower_photos'
INPUT_DATA = '/home/shinong/big_bumper/1213-20Kphoto/photo-aug'
# 验证的数据百分比
...
def main(_):
    ...
    with gfile.FastGFile(os.path.join(MODEL_FILE), 'rb') as f:
...
#    fc1 = tf.contrib.layers.fully_connected(bottleneck_input, 1024,activation_fn=tf.nn.relu)
#    fc1=tf.nn.dropout(fc1,0.5)
#    fc = tf.contrib.layers.fully_connected(fc1, 256, activation_fn=tf.nn.relu)
#    fc=tf.nn.dropout(fc,0.5)
    ...
    with tf.Session() as sess:
        ...
        for i in range(STEPS):
            ...
            loss,_=sess.run([cross_entropy_mean,train_step], feed_dict={bottleneck_input: train_bottlenecks, ground_truth_input: train_ground_truth})
        ...
        #saver.save(sess,'./fruit/orange')
        # 在最后的测试数据上测试正确率
       # saver.restore(sess, tf.train.latest_checkpoint('./fruit'))
